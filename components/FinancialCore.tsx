    ...
    <section id="financial" className="py-12 border-t border-[#E2DDD6] scroll-mt-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8">
        ...
        <div className="border border-[#E2DDD6]">
          <div className="px-4 py-3 border-b border-[#E2DDD6] flex items-center justify-between bg-[#FAF7F2]">
            <span className="label-caps">Treasury Intelligence</span>
          ...
          <div className="divide-y divide-[#E2DDD6]">
            {rows.map((row) => (
              <div key={row.label} className="flex items-center justify-between px-4 py-3">
                <span className="text-[10px] font-sans font-medium tracking-[0.12em] uppercase text-[#6B6660]">
                  {row.label}
                </span>
                <div className="flex items-center gap-2">
                  <span className={`font-sans text-[13px] font-semibold tabular-nums ${row.highlight ? "text-[#D4B596]" : "text-black"}`}>
                    {row.value}
                  </span>
